# <a href="repository.jokerREPO.zip">DOWNLOADDO REPOSITÓRIO</a>
...
<p align="left">
  <ul>
    ...
    <li>O endereço para a fonte é <code>https://tiny.one/7PlusREPO</code> (Dar o nome de "repository.jokerREPO").</li>
